...
set helix_assignment_script [file normalize [file join [file dirname [file normalize [info script]]] "./assign_helices_ELIC_CG.tcl"]] ;# script that will assigns occupancies in helixlist to different secondary structure elements 
